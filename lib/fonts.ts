...
export const FONT_OPTIONS: FontOption[] = [
  ...
  { key: "jost", label: "Jost", cssVar: "--font-jost", category: "Sans" },
  { key: "josefinsans", label: "Josefin Sans", cssVar: "--font-josefinsans", category: "Sans" },
];
...
export const VARIANT_DEFAULT_FONTS: Record<string, { heading: FontKey; body: FontKey }> = {
  ...
  // Ultramodern pairs a clean geometric sans (Jost) for headings/body with a
  // separate elegant script (--font-script / Parisienne) used only for the
  // brand name — see app/globals.css `.theme-ultramodern .font-script`.
  ultramodern: { heading: "josefinsans", body: "jost" },
};
