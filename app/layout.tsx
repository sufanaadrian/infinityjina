...
const josefinsans = Josefin_Sans({ variable: "--font-josefinsans", subsets: ["latin"], weight: ["100", "300", "400"] });
// Elegant signature script used only for the Ultramodern brand name (a thin,
// airy, freely-licensed stand-in for "Lile Dahliya Script", which isn't on
// Google Fonts). Allura reads as a modern luxury signature.
